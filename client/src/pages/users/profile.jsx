...
const Profile = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 my-10">
      ...
      {/* Enroled tournament section */}
      <div>
        <h1 className="font-medium text-lg">Tournament you're enrolled in</h1>

        {user?.enrolledTournaments?.length === 0 ? (
          <h1 className="text-red-500 my-5">You haven't enrolled yet</h1>
        ) : (
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 my-5">
            {user.enrolledTournaments.map((tournament) => (
