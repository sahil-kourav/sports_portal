import { LayoutDashboard, Trophy, ChevronsLeft, ChevronsRight, Users } from "lucide-react";
    ...
    <div className="flex">
      ...
      >
        ...
        <div className="space-y-4 mt-5">
          ...
          <SidebarLink to="enrolled-users" label="Enrolled Users" icon={<Users size={collapsed ? 30 : 25} />} active={location.pathname.startsWith("/enrolled-users")} collapsed={collapsed} />
        </div>
      </div>
