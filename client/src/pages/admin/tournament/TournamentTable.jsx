...
//           <TableRow>
//             <TableHead className="w-[120px] font-bold uppercase">Price</TableHead>
//             <TableHead className="font-bold uppercase">Status</TableHead>
//             <TableHead className="font-bold uppercase">Title</TableHead>
//             <TableHead className="text-right font-bold uppercase">Action</TableHead>
//           </TableRow>
//         </TableHeader>
...
//               <TableCell>
//                 <Badge
//                   className={`px-2 py-1 ${tournament.isPublished ? "bg-green-100 text-green-700" : "bg-gray-100 text-gray-700"
//                     }`}
//                 >
//                   {tournament.isPublished ? "Published" : "Draft"}
//                 </Badge>
//               </TableCell>
//               <TableCell className="text-gray-800">{tournament.tournamentTitle}</TableCell>
    ...
    <div className="p-4 sm:p-6 bg-white rounded-lg shadow-md w-full">
      ...
      <div className="overflow-x-auto">
        <Table className="border border-gray-200 min-w-[600px]">
          ...
          <TableHeader className="bg-gray-100">
            <TableRow>
              <TableHead className="w-[120px] font-bold uppercase text-sm sm:text-base">Price</TableHead>
                ...
                <TableCell>
                  <Badge
                    className={`px-2 py-1 text-xs sm:text-sm ${
                      tournament.isPublished ? "bg-green-100 text-green-700" : "bg-gray-100 text-gray-700"
                    }`}
                  >
                    {tournament.isPublished ? "Published" : "Draft"}
                  </Badge>
