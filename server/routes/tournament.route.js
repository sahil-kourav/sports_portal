...
const { createTournament, searchTournament, editTournament, deleteTournament, getTournamentById, getCreatorTournaments, getPublishedTournament, togglePublishTournament, enrollInTournament, getEnrolledTournaments, getTournamentDetailWithStatus } = require ("../controllers/tournament.controller");
