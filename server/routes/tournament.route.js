...
router
  .route("/:tournamentId")
  .put(isAuthenticated, upload.single("tournamentThumbnail"), editTournament)
  .delete(isAuthenticated, deleteTournament);
...
router
  .route("/enrolled-tournaments")
  .get(isAuthenticated, getEnrolledTournaments);

router
  .route("/:tournamentId/detail-with-status")
  .get(isAuthenticated, getTournamentDetailWithStatus);
